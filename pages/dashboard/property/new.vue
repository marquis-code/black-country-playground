    ...
    <div class="flex max-w-7xl mx-auto py-10">
      ...
      <aside class="w-1/4 space-y-4">
        <div
          ...
          :class="{
            'bg-[#5B8469] text-white': activeStep === step.id,
            'bg-gray-100': activeStep !== step.id,
          }"
        >
          <div
            class="w-10 h-10 flex items-center justify-center rounded-full mr-3 relative"
            :class="{
              'text-black': activeStep === step.id,
              'text-white': activeStep !== step.id,
            }"
          >
            <svg
              class="h-32 w-32"
            ...
            >
              <g opacity="0.8">
                <g clip-path="url(#clip0_5289_71526)">
          ...
          <h3
            :class="{
              'text-white': activeStep === step.id,
              'text-[#98A2B3]': activeStep !== step.id,
            }"
          >
            {{ step.title }}
          </h3>
      ...
      <div class="flex justify-between items-center">
        ...
        <form v-if="informationStep === 1" class="space-y-4">
          <div class="space-y-1">
            <label class="block text-[#1D2739]">Property name</label>
            <input
              type="text"
              class="w-full px-4 py-3 border bg-[#E4E7EC] rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
              placeholder="Enter full name"
            />
          </div>
          <div class="space-y-1">
            <label class="block text-[#1D2739]">Brief description</label>
            <textarea rows="6" cols="6"
              class="w-full px-4 py-2 resize-none border bg-[#E4E7EC] rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
              placeholder="Enter your reason for moving out"
            ></textarea>
          </div>
          <div class="space-y-1">
            <label class="block text-[#1D2739]">Building/property type</label>
            <input
              type="text"
              class="w-full px-4 py-3 border bg-[#E4E7EC] rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
          ...
          <div class="space-y-1">
            <label class="block text-[#1D2739]">Flooring type</label>
            <input
              type="text"
              class="w-full px-4 py-3 border bg-[#E4E7EC] rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
              placeholder="Enter your phone number"
          ...
          <div class="space-y-1">
            <label class="block text-[#1D2739]">Property size</label>
            <input
              type="text"
              class="w-full px-4 py-3 border bg-[#E4E7EC] rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
          ...
          <div  class="flex justify-between items-center">
            <label class="block text-[#1D2739]">Floor number</label>
            <div class="flex items-center space-x-2">
              <button
                type="button"
        ...
        <MapSection  v-if="informationStep === 2" />
