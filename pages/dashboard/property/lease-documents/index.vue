    ...
    <template #header-content>
      <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6 justify-between">
        <div class="flex items-center gap-x-4">
          ...
          <button
            @click="router.push('/dashboard/property')"
            class="bg-[#5B8469] font-medium px-4 py-3 rounded-md text-white"
          >
            Listings
          </button>
          <button
            @click="router.push('/dashboard/property/rental-applications')"
            class="text-[#292929] font-medium bg-[#F0F2F5] px-4 py-3 rounded-md"
          >
            Rental applications
          </button>
          <button
            @click="router.push('/dashboard/property/lease-documents')"
            class="text-[#292929] font-medium bg-[#F0F2F5] px-4 py-3 rounded-md"
          >
            Lease Documents
          </button>
      ...
      <div class="p-6">
        <section class="flex justify-between items-center">
          <div class="flex space-x-6 mb-4">
            <span
              class="text-lg font- text-[#326543] pb-2 border-b-4 border-[#326543] cursor-pointer"
              >All lease documents</span
            >
            <span class="text-lg font- text-gray-500 pb-2 cursor-pointer"
              >Pending signing</span
            >
            <span class="text-lg font- text-gray-500 pb-2 cursor-pointer"
              >Signed lease</span
            >
        ...
        <section class="grid grid-cols-4 gap-4">
          <div
            ...
            :key="itm"
          >
            <img :src="dynamicImage('lease-doc.png')" />
            <div class="flex justify-between items-center">
              <div class="space-y-1">
                <h6 class="text-base font-semibold text-gray-800">
                  Cummings, Frami and Lynch a...
                </h6>
                <p class="text-xs text-gray-600">
                  Tenant:
                  <span class="font-medium text-[#1D2739]">Ada Dennis</span>
                </p>
                <p class="text-xs text-gray-600">
                  Last updated:
                  <span class="font-medium text-[#1D2739]">15th May, 2024</span>
                </p>
              </div>
              <button class="p-2">
                <svg
