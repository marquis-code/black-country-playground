<template>
    ...
    <section>
      <div class="mb-6">
          <h3 class="text-base font-medium text-[#1D2739] mb-4 border-[0.5px] py-3 px-3 rounded-lg bg-white">Current residence</h3>
        </div>

      <div class="border-[0.5px] py-3 px-3 rounded-lg bg-white">
          <div class="space-y-5 p-3 text-sm">
              <p class="flex justify-between items-center text-[#1D2739]"><span class="text-[#667185] font-light">Current Home:</span> Cummings, Frami and Lynch</p>
              <p class="flex justify-between items-center text-[#1D2739]"><span class="text-[#667185] font-light">Room number:</span> 5</p>
              <p class="flex justify-between items-center text-[#1D2739]"><span class="text-[#667185] font-light">Current payment status:</span> Paid</p>
              <p class="flex justify-between items-center text-[#1D2739]"><span class="text-[#667185] font-light">Payment frequency:</span> Monthly</p>
              <p class="flex justify-between items-center text-[#1D2739]"><span class="text-[#667185] font-light">Payment count:</span> 3/6</p>
              <p class="flex justify-between items-center text-[#1D2739]"><span class="text-[#667185] font-light">Lease start date:</span> 03/01/2024</p>
              <p class="flex justify-between items-center text-[#1D2739]"><span class="text-[#667185] font-light">Lease end date:</span> 03/07/2024</p>
          </div>
      </div>
    </section>
      ...
      <section>
          ...
          <!-- Rental History -->
          <div class="mb-6 border-[0.5px] py-6 px-3 rounded-lg bg-white">
              <div class="space-y-5 p-3 text-sm">
              <p class="flex justify-between items-center text-[#1D2739]"><span class="text-[#667185] font-light">Current Landlord:</span> Chibuike Nweron</p>
