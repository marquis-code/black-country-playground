    ...
    <div class="py-6 space-y-6">
      ...
      <div class="flex items-center justify-between space-x-4">
        ...
        <div class="flex space-x-2">
          <button
            :class="{
              'bg-black text-white': isFurnishedCommonArea,
              'bg-white border border-gray-300 text-gray-700': !isFurnishedCommonArea
            }"
      ...
      <div>
        ...
        <fieldset>
          <legend class="sr-only">Exterior Checkboxes</legend>
      ...
      <!-- Add manually (Exterior) -->
      <div class="mt-4">
        <button
          class="text-sm text-[#5B8469]"
          @click="showExteriorInput = !showExteriorInput"
        >
          + Add manually
        </button>

        <div v-if="showExteriorInput" class="flex items-center space-x-4 mt-4">
          <input
...
const emit = defineEmits(['updateCommonAreas', 'updateIsFurnished']);
