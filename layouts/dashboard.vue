      ...
      <!-- <slot name="header-content">
        <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6 justify-between">
          <div class="flex items-center gap-x-4">
            ...
            <button class="bg-[#5B8469] font-medium px-4 py-3 rounded-md text-white">Overview</button>
            <button class="text-[#292929] font-medium bg-[#F0F2F5] px-4 py-3 rounded-md">Insights</button>
          </div>
